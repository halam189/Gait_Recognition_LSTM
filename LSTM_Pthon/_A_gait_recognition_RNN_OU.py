...
rnn_input_dim_list = torch.IntTensor([10]) # 2, 5   # the number of scalars that is fed to an LSTM node at each stage           #^#
...
trained_model_path = "..\\Dataset\\trained_models\\_A_gait_recognition_RNN_OU"
    ...
    for iTimes in range(0, experiment_times):
        ...
        if bLoadTrainedModel:
            ...
            while True:
                ...
                if validation_count == validation_threshold_RNN or math.isnan(curr_validate_loss.data):
        ...
        save_path = "..\\Dataset\\trained_models\\classification_result.txt"
